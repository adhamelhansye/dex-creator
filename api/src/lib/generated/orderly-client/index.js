...
path.join(process.cwd(), "src/lib/generated/orderly-client/libquery_engine-debian-openssl-1.1.x.so.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "src/lib/generated/orderly-client/schema.prisma")
