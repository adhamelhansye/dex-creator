    ...
    <div className="flex flex-col space-y-4 mt-6">
      <div className="flex flex-col gap-2">
        ...
        <p className="text-xs text-gray-400 mb-2">
          Describe how you want your DEX theme to look and our AI will generate
          it for you.
        </p>
          ...
          <div className="flex items-start gap-2">
            ...
            <div>
              <p className="text-xs text-gray-300 mb-1">
                ...
                AI-generated themes are a starting point and may not be perfect.
                After generating:
              </p>
              <ul className="text-xs text-gray-300 list-disc pl-4 space-y-0.5">
                ...
                <li>Use the DEX preview button to see your theme in context</li>
              </ul>
            </div>
          </div>
        </Card>
