          ...
          <div className="space-y-6 mb-8">
            <div className="bg-gradient-to-r from-primary/10 to-secondary/10 rounded-lg p-6 border border-primary/20">
              ...
              <p className="text-gray-300 mb-4">
                Graduation requires paying a fee in ORDER or USDC to unlock
                revenue-generating features for your DEX. Once graduated, your
                DEX becomes eligible to earn trading fees from users.
              </p>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-400">
                      Begin collecting trading fees as soon as users start
                      trading
                    </p>
                  </div>
                </div>
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-3">
                  ...
                  <p className="text-gray-300">
                    Pay the graduation fee in ORDER or USDC
                  </p>
                </div>
                <div className="flex items-center gap-3">
                  <div className="bg-info/20 text-info rounded-full w-6 h-6 flex items-center justify-center text-sm font-bold">
