export const caseStudies = {
  ...
  // Shared stats labels
  "caseStudies.stats.totalTradingVolume": "TOTAL TRADING VOLUME",
  "caseStudies.stats.dailyActiveUsers": "DAILY ACTIVE USERS",
  "caseStudies.stats.rankingOnCMC": "RANKING ON CMC",

  // ADEN-specific content
  "caseStudies.aden.description":
  ...
  "caseStudies.aden.treasury.title":
    "How Aden Turns Trading into Community Value",
  "caseStudies.aden.treasury.paragraph1":
  ...
  "caseStudies.aden.treasury.paragraph2":
  ...
  // NOOT-specific content
  "caseStudies.noot.description":
  ...
  "caseStudies.lol.stats.revenueUsedForBuybacks":
    "REVENUE USED TO LOL BUYBACKS",
  "caseStudies.lol.treasury.tokenBuybacks.title": "Token Buybacks & Burns",
  ...
  "caseStudies.lol.treasury.communityGrowth.title":
  ...
  "caseStudies.lol.treasury.cexListings.title":
    "Funding for Future CEX Listings",
  ...
  // Treasury section heading (NOOT/LOL layout)
  "caseStudies.treasury.sectionHeading":
    "Trading fees fund a self-sustaining treasury for:",

  // Footnote
  "caseStudies.note.firstTwoMonths":
    "All figures are based on the first two months following the DEX's launch.",
};
